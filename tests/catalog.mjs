...
assert.ok(models.length >= 36, 'expected the documented DreamAPI capability catalog');
...
for (const model of models) {
  ...
  assert.ok(model.endpoint === null || model.endpoint.startsWith('/api/'), `${model.id}: DreamAPI endpoint`);
